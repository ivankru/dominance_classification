...
def main(
    ...
    exp_number - номер эксперимента для конфига
    video_size - разрешение видео
    ...
    # loading of information about splitting into folds and hold out of the main dataset
    ...
    for i in range(5):
        ...
        # создадим список пациентов для тестирования
        test_studies = np.copy(holdout)
        
        # создадим датасеты для тестирования по кадрам и видео
