...
from utils import *
from dataset_class import HeartLR_simple_main, HeartLR_simple_test_labeled
...
@click.option("--is_domain_shift_dataset", type=bool, is_flag=True, show_default=True, default=True,
                help="flag, is dataset the domain shift")
def main(
    exp_number: str,
    ...
    if is_domain_shift_dataset:
        dataset_rca = HeartLR_simple_test_labeled(dataset_folder, returns_type="pipeline", transform=val_transform, 
    ...
    if is_domain_shift_dataset:
        dataset_lca = HeartLR_simple_test_labeled(dataset_folder, returns_type="pipeline", transform=val_transform, 
