...
def get_study_preds_for_model(models_folder: str, model: Any, dataloader: DataLoader, best_model_loss: str, dataset_study_series_dict: dict,
                              predicted_series_list: Optional[List[str]] = None, model_type: Optional[str] = None,
                              dataset_series_dict: Optional[dict] = None, device: str = "cpu") -> Tuple[dict, dict]:
    """
